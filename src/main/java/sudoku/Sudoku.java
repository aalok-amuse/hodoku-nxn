...
public class Sudoku {
	...
	private SudokuSetBase[] possiblePositions = new SudokuSetBase[17];
	// Ein Template pro Kandidat mit allen noch möglichen Positionen
	private SudokuSetBase[] allowedPositions = new SudokuSetBase[17];
	// Ein Template pro Kandidat mit allen gesetzten Positionen
	private SudokuSet[] positions = new SudokuSet[17]; // 9x9 Sudoku, linearer Zugriff (ist leichter)
